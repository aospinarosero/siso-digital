...
import { useBitacoraStore } from '../flux/stores/bitacora'
import { useSyncStore } from '../flux/stores/sync'
...
// Toda accion pasa por aqui antes de tocar un store, y por eso el flujo es
// reconstruible despues de un incidente.
